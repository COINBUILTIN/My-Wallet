...
- (void)viewDidLoad {
    ...
    [self.segmentCurrency setTintColor:[UIColor redColor]];
    [self.segmentCurrency setBackgroundColor:[UIColor redColor]];
//    [self.segmentCurrency setBackgroundColor:[UIColor colorWithRed:0 green:0.53 blue:0.92 alpha:1.0]];
